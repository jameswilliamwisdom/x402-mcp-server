...
x402 gives your AI agent access to pay-per-use APIs — screenshots, PDF extraction, and crypto intelligence. One install, no API keys. Free test mode is available immediately; paid mode unlocks any URL with a USDC wallet on Base.

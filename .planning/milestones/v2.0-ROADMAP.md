...
- [x] **Phase 16: MCP Server Update + npm Publish** - Register x402_crawl_site, update email and convert Zod schemas, publish v2.0.0 (completed 2026-04-06)
...
| 16. MCP Server Update + npm Publish | v2.0 | 2/2 | Complete | 2026-04-06 |
